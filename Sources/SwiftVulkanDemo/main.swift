...
import class SwiftGUI.Application
import ApplicationBackendSDL2

// SPRIV Compiler? https://github.com/stuartcarnie/SwiftSPIRV-Cross

public class VulkanApplication: SwiftGUI.Application {
  @Deferred var window: SDL2Window
  ...
  public init() throws {
    super.init(backend: try ApplicationBackendSDL2.getInstance())
